...
Linux)
	...
	route del default
    route add default gw ${REMOTE_ADDR} dev ${if}:1
...
echo "spdadd ${INTERNAL_ADDR4}/32[any] 0.0.0.0/0[any] any -P out ipsec
    esp/tunnel/${LOCAL_ADDR}-${REMOTE_ADDR}/require;" | setkey -c
echo "spdadd 0.0.0.0/0[any] ${INTERNAL_ADDR4}/32[any] any -P in ipsec
