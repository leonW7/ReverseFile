-- Lua 5.0/5.1 init file for Kepler
--
...
--
-- $Id: t_kepler_init.lua,v 1.9 2007/05/17 23:25:10 hisham Exp $

-- Lua 5.1 paths
local conf51    = [[/pfrm2.0/etc/kepler/1.1]]
local luabase51 = [[/pfrm2.0/share/lua/5.1]]
local libbase51 = [[/pfrm2.0/lib/lua/5.1]]
