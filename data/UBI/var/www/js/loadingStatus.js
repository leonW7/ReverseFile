...
function displayProgressBar () {
    ...
    // Below code required for IPS/IDS issue.
    $("div.msgInfoLoading").css({'min-height': '40px'});
    $("#tf1_pageLoadingMask p").text(LANG_LOCALE['13581']+"...");
}
...
/*Bind the unload event */
    $(document).ready(function(){
			if($("#tf1_overlay").length == 0){
				$('body').prepend('<div id="tf1_overlay" class="configDialogMask"></div>');		
			}
