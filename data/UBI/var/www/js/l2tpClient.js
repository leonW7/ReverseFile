 ...
 * OnLoad validation
 * @method l2tClientOnload
 */


    $(document).ready(function(){
        onloadCall(l2tpClientOnload, {imageId:'tf1_enableL2TPClient', disableIndividual:'', disableGrp:'tf1_reconnectMode tf1_L2TPClientConfigBlock', enableIndividual:'', enableGrp:'', hideClass:'hide', showClass:'configRow', breakDivs:'', breakClass:'break', imagesInfo:{disableImages:'', enableImages:'', disableClass:'', enableClass:''}});
         enableTextFieldByAnchorClick('tf1_imageClientSetup','tf1_serverIP tf1_remoteNetwork tf1_RemoteMask tf1_UserName tf1_Password tf1_timeOut tf1_enableMppe tf1_autoDial tf1_recModeType tf1_mppeEncrypt tf1_alwaysOn tf1_onDemand tf1_hid_autoDial tf1_time','break1 break2 break3 break4 break5 break6 break7 break8 break9 break10');
         
         if ($("#tf1_imageClientSetup").attr("class") == "enable-disable-on") {                
                enableTextFieldByAnchorClick('tf1_autoDial','tf1_time','break10');
            }
         changeReconnectModeType('tf1_alwaysOn');
    });
 ...
 */
function l2tpClientOnload(data, thisObj){
    onAnchorToggle(data);
    var imgId=thisObj.id;
    
    switch(imgId){
           case 'tf1_imageClientSetup':
               enableTextFieldByAnchorClick('tf1_imageClientSetup','tf1_serverIP tf1_remoteNetwork tf1_RemoteMask tf1_UserName tf1_Password tf1_timeOut tf1_enableMppe tf1_autoDial tf1_recModeType tf1_mppeEncrypt tf1_alwaysOn tf1_onDemand tf1_hid_autoDial tf1_hid_autoDial tf1_time', 'break1 break2 break3 break4 break5 break6 break7 break8 break9 break10');
 ...
 * @method l2tpClientValidate
 */
function l2tpClientValidate(frmId){
    ...
    if (featureValue == "1")
        {
        var proceed = confirm (LANG_LOCALE['50063']);
        if (proceed == false)
            {
            return false;
            }
...
/****
 * This function calls onReset
 * @method l2tpClientValidate
 */

function l2tpClientOnreset() {

  
        onloadCall(l2tpClientOnload, {imageId:'tf1_enableL2TPClient', disableIndividual:'', disableGrp:'tf1_reconnectMode tf1_L2TPClientConfigBlock', enableIndividual:'', enableGrp:'', hideClass:'hide', showClass:'configRow', breakDivs:'', breakClass:'break', imagesInfo:{disableImages:'', enableImages:'', disableClass:'', enableClass:''}});

        enableTextFieldByAnchorClick('tf1_imageClientSetup','tf1_serverIP tf1_remoteNetwork tf1_RemoteMask tf1_UserName tf1_Password tf1_timeOut tf1_enableMppe tf1_autoDial tf1_recModeType tf1_mppeEncrypt tf1_alwaysOn tf1_onDemand tf1_hid_autoDial','break1 break2 break3 break4 break5 break6 break7 break8 break9 break10');
...
function changeReconnectModeType(radioName){
    ...
    switch (parseInt(selValue, 10)){
	    case 1:	
	    	fieldStateChangeWr('tf1_timeOut','','','');	    	
	    	vidualDisplay('tf1_timeOut','hide');	 	    	   	
			vidualDisplay('break8','hide');	
	    break;
	    case 2: 	    	    	
		   	fieldStateChangeWr('','','tf1_timeOut','');	    	
	    	vidualDisplay('tf1_timeOut','configRow');	    	  	
