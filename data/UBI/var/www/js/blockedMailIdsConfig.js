/*
 * File: blockedMailIdsConfig.js
 * TeamF1 Inc, 2012
 * Created on 8th Nov 2012 - Bala Krishna G
 */
/****
 * validate the form
 * @method blockedMailIdsValidate
 */
function blockedMailIdsValidate(){
    var txtFieldIdArr = new Array();
    txtFieldIdArr[0] = "tf1_blockedMail,"+LANG_LOCALE['12312'];
    ...
    if (echeck('tf1_blockedMail') == false) 
        return false;
