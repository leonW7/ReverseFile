	...
	*/
    function Scroller(elm, settings){
        ...
        that.show = function(){
            ...
            read();
            if(typeof s.cusotmDivId == 'undefined' || s.cusotmDivId == ''){
            	cusotmDivId = '';
            }else{
            	cusotmDivId = s.cusotmDivId;
            }
            // Create wheels containers
            var html = '<div id="' + cusotmDivId + '" class="' + s.theme + '">' + ('<div class="dw dwbg dwi"><div class="dwwr">');
